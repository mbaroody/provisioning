...
"center screen when jumping to next search match
" nmap n nzz
...
nnoremap <silent> gts :exe 'CocList -I --normal --input='.expand('<cword>').' symbols'<CR><CR>
...
" show cocAction
nnoremap <silent><nowait> <space>ac  :<C-u>CocAction<CR>
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
nmap <silent> vtb <Plug>VimspectorToggleBreakpoint
nmap <silent> vdl :call vimspector#Launch()
nmap <silent> vdr <Plug>VimspectorRestart
nmap <silent> vdc <Plug>VimspectorContinue
nmap <silent> vdsov <Plug>VimspectorStepOver
nmap <silent> vdsou <Plug>VimspectorStepOut
nmap <silent> vdsi <Plug>VimspectorStepInto
